...
public class ProdutoController {
    ...
    public ResponseEntity<List<Produto>> getByItem(@PathVariable 
    String item){
    ...
    public List<Produto> getByPreco(@PathVariable  BigDecimal precoMin, @PathVariable  BigDecimal precoMax) {
